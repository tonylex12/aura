...
export default function Dashboard({ stats, onStartScenario, onSwitchView }: DashboardProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between p-6 lg:p-10 relative overflow-hidden glass-panel">
        <div className="max-w-full md:max-w-[60%] flex flex-col justify-center z-10 space-y-4">
          <h3 className="text-3xl lg:text-4xl font-extrabold bg-gradient-to-r from-white to-text-secondary bg-clip-text text-transparent leading-tight">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <button 
              onClick={() => onSwitchView("chat-simulator")}
            ...
            <button 
              onClick={() => onSwitchView("pronunciation-sandbox")}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-5">
        ...
        <div className="p-6 glass-panel flex flex-col space-y-4">
          <h4 className="text-lg font-bold text-text-primary border-b border-white/5 pb-2.5">
          ...
          <div className="flex flex-col gap-3">
            {recommendedActivities.map((act) => (
              <div
                key={act.id}
                onClick={() => onStartScenario(act.id)}
        ...
        <div className="p-6 glass-panel flex flex-col space-y-4">
          ...
          <div className="flex flex-col gap-3.5">
            ...
            <div className="pt-2">
              <button 
                onClick={() => onSwitchView("flashcards")}
